  ...
  #define STRING_CONFIG_H_AUTHOR "(MikeB, E5+ SKR-E3V3 Hemera)" // Who made the changes.
...
#define E0_DRIVER_TYPE TMC2209
   ...
   */
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.1, 80.04, 794, 394 }
   ...
   *     O-- FRONT --+
   */
  #define NOZZLE_TO_PROBE_OFFSET { -39, 6, -1}
