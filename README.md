...
<h1 align="center">Custom version of Marlin 3D Printer Firmware</h1>

Additional documentation can be found at the [Marlin Home Page](//marlinfw.org/).

## Custom Changes
This has been compiled to support the following printer
Ender 5 plus 
V6 Hemera hot end 
Bltouch  (3D Touch)
BIGTREETECH Upgraded SKR Mini E3 V3.0 
BIGTREETECH TFT35 V3.0.1 Display
